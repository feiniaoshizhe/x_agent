...
- 🗄️ **Database**: MySQL with SQLModel
- 📦 **Database Migrations**: Alembic support
- 🔐 **Authentication**: complete
- 🔄 **Refresh Token**: Secure token refresh
- 🔴 **Redis**: Caching and session management
- 📋 **Background Tasks**: Celery with Redis broker
- 💾 **Database Backup**: Automated backup tasks (MySQL, PostgreSQL, SQLite)
- 🌐 **CORS**: Cross-Origin Resource Sharing enabled
- 🔒 **Security**: Input Validation, Password Hashing, Rate Limiting
- 🧪 **Testing**: pytest with async support and coverage
- 🐳 **Docker**: Production-ready containerization
- 🛠️ **Development Tools**: Black, Ruff for code quality
...
├── script/                 # Custom scripts (shell script,  etc.)
...
- **Database**: MySQL database with health checks
